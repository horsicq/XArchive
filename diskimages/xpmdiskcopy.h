...
//
// The reference implementation validates the copied BPB rather than the string alone, and this class
...
// and sectorsPerCluster must be one of the values in the reference implementation's bitmap at 0x425ba0
...
// then a job for the file-system reader, exactly as the reference implementation does it.
