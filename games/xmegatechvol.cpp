...
// The reference implementation: verbatim: the table must be non-decreasing
...
bool XMegatechVOL::parseContext(CONTEXT *pContext, PDSTRUCT *pPdStruct)
{
    ...
    // stops one short of the table's end (the reference implementation iterates 0.. nCount - 2).
    qint32 nNumber = 0;
