...
// U3 provenance: catalog 759, VMT 0049c048 -> 004a2380 -> 0042aaf0;
...
bool vhdxRegions(Reader &r, DiskPlan &p, const QByteArray &table, quint64 logOffset,
    ...
    // U3 0042a6d0, GUID pointers 00a0ab50 and 00a0b450.
...
bool parseVHDX(Reader &r, DiskPlan &p) {
    ...
    // U3 0042a5a0/0042a570 validate both 4-KiB headers and select the
    // unique newest sequence. CRC32C over a zeroed checksum field is
    // equivalent to U3 0042a540's precomputed initial state after 8 bytes.
    ...
    // U3 0042a840 metadata GUIDs/field widths are recovered from the EXE.
    // Virtual/physical sector and disk-ID requirements are additionally
    // checked instead of accepting U3's partially populated context.
    ...
    // Direct port of U3 0042ab10 (+0x60 chunk ratio) and 0042ad20.
    ...
    for (quint64 i = 0; i < blocks && r.active(); ++i) {
        ...
        if (state == 6) {
            ...
            // U3 0042adc0 zero-filled every unsuccessful BAT lookup. Here
