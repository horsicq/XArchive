 ...
 * MIT License
 */
#ifndef XLEGACYCONSOLE_H
#define XLEGACYCONSOLE_H

#include "xarchiveconsole.h"

// Opt-in the reference implementation command adapter. Native and 7-Zip parsing remain untouched.
class XLegacyConsole {
public:
