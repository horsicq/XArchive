...
// actually holds (COMM.SWG, truncated in transit); U3 reports those as errors
...
// exact on all 1213 members of the 22-file corpus against U3, so members are
// published as the existing HANDLE_METHOD_LZH1 and no codec is added.
//
// Note that U3 additionally trims trailing NUL/TAB/LF/CR/space bytes and up to
...
// full uncompressed size the header declares, of which U3's output is a strict
