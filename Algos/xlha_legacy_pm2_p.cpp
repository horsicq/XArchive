...
#include "xlha_legacy_tree_p.inc"
...
static int lha_pm2_decoder_init(void *data, XLhaLegacyDecoderCallback callback,
                                void *callback_data)
{
...
const XLhaLegacyDecoderType xlha_legacy_pm2_decoder = {
