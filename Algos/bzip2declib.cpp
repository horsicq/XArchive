 ...
 * unchanged -- verified byte-for-byte against the pre-conversion symbol table.
 *
 * The upstream bzip2.c command-line driver is deliberately NOT included: it
 * defines main(), and this file is compiled as a plain translation unit by
 * xarchive.pri, so including it collides with every application's own main().
 *
 * bzlib.h stays a real header in Algos/include -- consumers outside XArchive
 * include it directly.
 *
...
/* amalgamation: the Algos sources are compiled as C++; without this the
   internal symbols below (BZ2_blockSort, BZ2_decompress, BZ2_crc32Table, ...)
   would be name-mangled. Same idiom as bzlib.h. */
#ifdef __cplusplus
extern "C" {
#endif
