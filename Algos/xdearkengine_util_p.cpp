...
XDearkMemory de_reallocarray(deark *c, void *m, i64 oldnmemb, size_t membsize,
	i64 newnmemb)
{
...
XDearkMemory de_realloc(deark *c, void *oldmem, i64 oldsize, i64 newsize)
{
	void *newmem;
