...
// payload offset - which is what the reference implementation does too and it is
...
// No new codec, and no HANDLE_METHOD of this family's own. The reference implementation behaves the same
