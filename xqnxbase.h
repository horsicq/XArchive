...
//           following two dwords are the constant part U3 keys on)
...
//                                           fixed offsets.  U3 only ever tries
...
// as U3 does - the published members are the regular files only, and the
// directory structure comes back from the slashes in their paths.
//
// Reference: U3.unp.exe handler A458 ("QNX Base", class dcb, VMT slots
