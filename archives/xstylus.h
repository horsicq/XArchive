...
// comes from the reference implementation's own handler table.
//
...
//
// The decompressed member has no stored name either. The reference implementation names it after the
