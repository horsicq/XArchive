// The reference implementation RZIP adapter.
#ifndef XRZIPARCHIVE_H
#define XRZIPARCHIVE_H

#include "xarchive.h"
#include "Algos/xrzipdecoder.h"
...
private:
    struct CONTEXT { XRzipDecoder::HEADER header; QString name; };
    bool readHeader(XRzipDecoder::HEADER *header, PDSTRUCT *progress);
};
