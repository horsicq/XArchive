...
// Only the three tags the reference implementation accepts, and only onto decoders that
...
// "-mg" then one of 0/4/5 then '-'. The reference implementation tests the method character with the
