...
// +0x02 u16 0x0200 format version (the sibling IGF variant the reference implementation handles
...
// +0x20 u32 checksum of the plaintext (algorithm unknown; the reference implementation does not
...
// safe: the reference implementation's detector checks exactly those relations.
//
...
// The reference implementation runs it through its shared LHA core with exactly those two
