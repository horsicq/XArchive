...
// from being mis-detected (the reference implementation rejects them the same way).
//
...
// size equals the uncompressed size the member is stored verbatim - the reference implementation misses
...
public:
    struct MEMBER {
        ...
        quint32 nAttributes;
        bool bStored;
        QString sFileName;  // base name, as the reference implementation reports it
