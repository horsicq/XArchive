...
// +0x19 u16 integrity word. The reference implementation wraps the output stream in a 16-bit
//                      checksum filter seeded with 0x3456 and then compares
//                      this field against the one's complement of the result
// . The filter's update rule was not
...
// directory). The reference implementation additionally keys on the fixed eight bytes at +0 - which are
