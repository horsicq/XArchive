...
#include "xarchive.h"
#include "Algos/xcpmcrunchdecoder.h"
...
private:
    struct CONTEXT { XCpmCrunchDecoder::Header header; QString sFileName; qint64 nUncompressedSize = 0; };
    bool readHeader(XCpmCrunchDecoder::Header *pHeader, PDSTRUCT *pPdStruct, qint64 *pUncompressedSize = nullptr,
                    qint64 nOutputLimit = XCpmCrunchDecoder::MaxOutput);
    const FT m_fileType;
};
